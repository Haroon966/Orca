...
// Servers prefixed with `orca-` (or legacy `cloudcli-`) are managed automatically.
const isManagedServer = (server: ProviderMcpServer): boolean =>
  server.name.startsWith('orca-') || server.name.startsWith('cloudcli-');
