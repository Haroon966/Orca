import { Bell, Bot, FileCode2, GitBranch, Info, Key, ListChecks, MonitorPlay, Palette, Puzzle } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { id: 'claude-config', labelKey: 'mainTabs.claudeConfig', icon: FileCode2 },
