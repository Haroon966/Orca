    ...
    <div className="border-t border-border/50 pt-6">
      <div className="space-y-4">
        <div className="flex items-center gap-3">
          <img src="/logo.svg" alt={ORCA_PRODUCT_NAME} className="h-9 w-9 rounded-lg" />
          <div>
            <div className="flex items-center gap-2">
              <span className="text-sm font-semibold text-foreground">{ORCA_PRODUCT_NAME}</span>
              <a
                href={releasesUrl}
                target="_blank"
            ...
            <p className="mt-0.5 text-xs text-muted-foreground">{ORCA_TAGLINE}</p>
          </div>
        </div>
