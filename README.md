> **ClaudeUI fork:** This workspace is customized as [ClaudeUI](CLAUDEUI.md) — a Claude Code CLI management interface. See [CLAUDEUI.md](CLAUDEUI.md) for setup, production deployment, and fork-specific features.
